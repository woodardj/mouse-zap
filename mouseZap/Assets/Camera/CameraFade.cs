...
// from http://wiki.unity3d.com/index.php?title=FadeInOut#Another_Fade_Script_in_C.23

// USE:
// CameraFade.StartAlphaFade( Color.white, false, 2f, 2f, loadLevelOnComplete("GameScene") );
//	void loadLevelOnComplete( string levelName )
//	{
